...
public class InputFlower extends Flower {

    public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);

    public InputFlower() {
        super(Material.PLANTS);
        setUnlocalizedName(SpellGarden.MODID + ".inputflower");
        setRegistryName("inputflower");
    }
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new InputFlowerTileEntity();
    }

    private InputFlowerTileEntity getTE(World world, BlockPos pos) {
        return (InputFlowerTileEntity) world.getTileEntity(pos);
    }
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand,
        ...
        if (!world.isRemote) {
            ...
            if (side == state.getValue(FACING)) {
                ...
                TextComponentTranslation component = new TextComponentTranslation("message.spellgarden.counter_par", counter);
